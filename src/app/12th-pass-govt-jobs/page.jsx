...
export default async function TwelfthPassGovtJobsPage() {
    const jobs = await getJobsByCategory("12th Pass Govt Job");

    return (
        <JobPageTemplate 
            category="12th Pass Govt Job" 
            title="12th Pass Govt Jobs" 
