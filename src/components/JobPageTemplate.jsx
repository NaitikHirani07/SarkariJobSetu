...
const JobPageTemplate = ({ category, title, description }) => {
    const filteredJobs = category
        ? govtJobsList.filter(job => {
            if (Array.isArray(job.category)) return job.category.includes(category);
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-700 mb-6 font-medium">
                        ...
                        <h2 className="text-xl font-bold text-[#1976D2] mt-4">Latest {category || 'Government'} Jobs Vacancy 2025</h2>
                    </div>
